...
== https://github.com/d4l-data4life/hc-util-sdk-kmp/compare/1.12.1\...main[Unreleased]
...
== https://github.com/d4l-data4life/hc-util-sdk-kmp/compare/1.12.0\...1.12.1[1.12.1]
